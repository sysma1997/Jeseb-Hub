...
describe("Account Domain", () => {
    it("Should create an account with correct properties.", () => {
        ...
        const account = new Account(mockTranslator, "Bank", 120, id, idUser);
    ...
    it("Should throw an error when creating an account with missing name.", () => {
        expect(() => new Account(mockTranslator, "")).toThrow("The name is required.");
    });
});
